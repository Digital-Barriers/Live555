...
RTPSource::RTPSource(UsageEnvironment &env, Groupsock *RTPgs,
    ...
    : FramedSource(env), fRTPInterface(this, RTPgs),
      ...
      fTimestampFrequency(rtpTimestampFrequency), fSSRC(our_random32()),
...
void RTPReceptionStats ::noteIncomingPacket(
  ...
  if (useForJitterCalculation && rtpTimestamp != fPreviousPacketRTPTimestamp) {
    ...
    arrival +=
        (unsigned)((2.0 * timestampFrequency * timeNow.tv_usec + 1000000.0) /
                   2000000);
    // note: rounding
