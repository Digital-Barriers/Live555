...
unsigned
DVVideoRTPSink::computeOverflowForNewFrame(unsigned newFrameSize) const {
  ...
  // data that we use is an integral number of DIF blocks:
...
char const *
DVVideoRTPSink::auxSDPLineFromFramer(DVVideoStreamFramer *framerSource) {
