...
MPEG1or2VideoStreamFramer::MPEG1or2VideoStreamFramer(UsageEnvironment &env,
  ...
  fParser = createParser ? new MPEG1or2VideoStreamParser(this, inputSource,
...
MPEG1or2VideoStreamParser ::MPEG1or2VideoStreamParser(
    ...
    : MPEGVideoStreamParser(usingSource, inputSource),
      fCurrentParseState(PARSING_VIDEO_SEQUENCE_HEADER), fVSHPeriod(vshPeriod),
...
unsigned MPEG1or2VideoStreamParser ::parseVideoSequenceHeader(
  ...
  fprintf(stderr,
          ...
          frame_rate_code, usingSource()->fFrameRate, bit_rate_value,
  ...
  setParseState((next4Bytes == GROUP_START_CODE) ? PARSING_GOP_HEADER_SEEN_CODE
                                                 : PARSING_PICTURE_HEADER);
...
#if defined(DEBUG) || defined(DEBUG_TIMESTAMPS)
  fprintf(stderr,
          "time_code: 0x%07x, drop_frame %d, hours %d, minutes %d, seconds %d, "
          "pictures %d\n",
