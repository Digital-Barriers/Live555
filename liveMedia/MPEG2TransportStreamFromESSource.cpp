...
MPEG2TransportStreamFromESSource ::createNew(UsageEnvironment &env) {
...
MPEG2TransportStreamFromESSource ::MPEG2TransportStreamFromESSource(
    ...
    : MPEG2TransportStreamMultiplexor(env), fInputSources(NULL),
      fVideoSourceCounter(0), fAudioSourceCounter(0),
...
void InputESSourceRecord ::afterGettingFrame1(unsigned frameSize,
  ...
  if (numTruncatedBytes > 0) {
    fParent.envir()
        << "MPEG2TransportStreamFromESSource: input buffer too small; increase "
           "\"MPEG2TransportStreamFromESSource::maxInputESFrameSize\" by at "
           "least "
