...
FramedSource *
MP3ADUinterleaverBase::getInputSource(UsageEnvironment &env,
...
public:
  ...
  void getReleasingFrameParams(unsigned char index, unsigned char *&dataPtr,
                               ...
                               struct timeval &presentationTime,
                               unsigned &durationInMicroseconds);
  void setFrameParams(unsigned char index, unsigned char icc, unsigned char ii,
...
MP3ADUinterleaver::MP3ADUinterleaver(UsageEnvironment &env,
    ...
    : MP3ADUinterleaverBase(env, inputSource), fInterleaving(interleaving),
      fFrames(new InterleavingFrames(interleaving.cycleSize())), fII(0),
      fICC(0) {}

MP3ADUinterleaver::~MP3ADUinterleaver() { delete fFrames; }

MP3ADUinterleaver *
MP3ADUinterleaver::createNew(UsageEnvironment &env,
                             Interleaving const &interleaving,
                             FramedSource *inputSource) {
...
void MP3ADUinterleaver::afterGettingFrame(unsigned numBytesRead,
  ...
  fFrames->setFrameParams(fPositionOfNextIncomingFrame, fICC, fII, numBytesRead,
...
MP3ADUdeinterleaver::MP3ADUdeinterleaver(UsageEnvironment &env,
    ...
    : MP3ADUinterleaverBase(env, inputSource),
      fFrames(new DeinterleavingFrames), fIIlastSeen(~0), fICClastSeen(~0) {}
