...
Boolean
RawQCELPRTPSource ::processSpecialHeader(BufferedPacket *packet,
                                         unsigned &resultSpecialHeaderSize) {
...
BufferedPacket *
QCELPBufferedPacketFactory ::createNewPacket(MultiFramedRTPSource *ourSource) {
...
QCELPDeinterleavingBuffer::QCELPDeinterleavingBuffer()
    : fIncomingBankId(0), fIncomingBinMax(0), fOutgoingBinMax(0),
      fNextOutgoingBin(0), fHaveSeenPackets(False) {
...
#ifdef DEBUG
    fprintf(stderr,
            "QCELPDeinterleavingBuffer::deliverIncomingFrame() param sanity "
