...
static ServerMediaSession *
createNewSMS(UsageEnvironment &env, char const *fileName, FILE *fid); // forward
...
static ServerMediaSession *createNewSMS(UsageEnvironment &env,
  ...
  if (strcmp(extension, ".aac") == 0) {
    ...
    // Matroska files)
    OutPacketBuffer::maxSize =
        2097152; // allow for some possibly large VP8 or VP9 frames
    ...
    MatroskaFileServerDemux::createNew(env, fileName, onMatroskaDemuxCreation,
                                       &creationState);
