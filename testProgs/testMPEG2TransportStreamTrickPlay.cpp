...
int main(int argc, char const **argv) {
  ...
  FramedSource *input = ByteStreamFileSource::createNew(*env, inputFileName,
  ...
  // The index file name is the same as the input file name, except with suffix
  // ".tsx":
  ...
  if (startTime > 0.0f) {
    // Seek the input Transport Stream and Index files to the specified start
    // time:
